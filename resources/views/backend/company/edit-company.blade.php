    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="{{route('company')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="companyName" name="name" value="{{$company->name}}" type="text"
                                       class="form-control" placeholder="Enter Company Name...">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="companySolgan" class="form-label">Company Slogan</label>
                                <input id="companySolgan" name="slogan" type="text" value="{{$company->slogan}}"
                                       class="form-control" placeholder="Enter Company Solgan...">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                @if($company->logo_one)
                                    <input id="companyLogoOne" name="logo_one" type="file" class="form-control dropify"
                                           data-default-file="{{asset('/')}}{{$company->logo_one}}">
                                @else
                                    <input id="companyLogoOne" name="logo_one" type="file" class="form-control dropify">
                                @endif
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                @if($company->logo_two)
                                    <input id="companyLogoTwo" name="logo_two" type="file" class="form-control dropify"
                                           data-default-file="{{asset('/')}}{{$company->logo_two}}">
                                @else
                                    <input id="companyLogoTwo" name="logo_two" type="file" class="form-control dropify">
                                @endif
                            </div>
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea id="about_blog" name="about_blog" type="text" class="form-control summernote">{!! $company->about_blog !!}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="mission" class="form-label">Mission</label>
                                <textarea id="mission" name="mission" type="text"
                                          class="form-control summernote">{{$company->mission}}</textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="vision" class="form-label">Vision</label>
                                <textarea id="vision" name="vision" type="text"
                                          class="form-control summernote">{{$company->vision}}</textarea>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="companyEmail" class="form-label">Company Email</label>
                                <input id="companyEmail" name="email" type="email" value="{{$company->email}}"
                                       class="form-control" placeholder="Enter Company Email...">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="companyPhoneOne" class="form-label">Company Phone Number</label>
                                <input id="companyPhoneOne" class="form-control" value="{{$company->phone_one}}"
                                       type="text" name="phone_one">
                            </div>
                            {{--                            <div class="col-md-4 mb-3">--}}
                            {{--                                <label for="companyPhoneTwo" class="form-label">Company Phone Number</label>--}}
                            {{--                                <input id="companyPhoneTwo" class="form-control" value="{{$company->phone_two}}"--}}
                            {{--                                       type="text" name="phone_two">--}}
                            {{--                            </div>--}}
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Select Color</label>
                                <input type="text" name="company_color" class="form-control" id="colorpicker-default" value="{{$company->company_color}}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="companyFacebook" class="form-label">Company Facebook</label>
                                <input id="companyFacebook" class="form-control" value="{{$company->fb_link}}"
                                       type="text" name="fb_link">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="companylinkedin" class="form-label">Company Linkedin</label>
                                <input id="companylinkedin" class="form-control"  value="{{$company->linked_link}}" type="text" name="linked_link">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="companyTwitter" class="form-label">Company Twitter</label>
                                <input id="companyTwitter" class="form-control" value="{{$company->twitter_link}}"
                                       type="text" name="twitter_link">
                            </div>
                            <div class="mb-3">
                                <label for="companyAddress" class="form-label">Company Address</label>
                                <textarea id="companyAddress" name="address" type="text"
                                          class="form-control summernote">{{$company->address}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <button type="submit" class="btn btn-block btn-primary">Update Company Information</button>
                    </div>
                </div>
            </form>
        </div>
